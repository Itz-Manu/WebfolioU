          ...
          <div className="flex h-[100vh] my-5 bg-gray-100">
            ...
            <div className="w-72 bg-gray-800 text-white p-4">
              ...
              <ul className='font-medium'>
                <li className={`cursor-pointer py-2 px-4 mb-2 rounded ${selectedNavItem === 'TODO-Basic' ? 'bg-orange-500' : 'hover:bg-gray-700'}`}
                  onClick={() => handleNavItemClick('TODO-Basic')}
                > TODO-Basic</li>

                <li className={`cursor-pointer py-2 px-4 mb-2 rounded ${selectedNavItem === 'Blog-App' ? 'bg-orange-500' : 'hover:bg-gray-700'}`}
                  onClick={() => handleNavItemClick('Blog-App')}
                > Blog-App</li>

                <li className={`cursor-pointer py-2 px-4 mb-2 rounded ${selectedNavItem === 'Quiz-App' ? 'bg-orange-500' : 'hover:bg-gray-700'}`}
